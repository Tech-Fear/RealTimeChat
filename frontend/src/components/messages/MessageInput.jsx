  ...
  return (
    <form className='px-4 my-3' onSubmit={handleSubmit}>
        <div className='w-full relative'>
            <input type="text" className='border text-sm rounded-lg block w-full p-2.5 text-black bg-gray-100' placeholder='Type Your Message...' value={message} onChange={(e)=>setMessage(e.target.value)}/>
